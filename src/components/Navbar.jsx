        ...
        <div className="flex items-center justify-between h-20">
            ...
            >
              <div className="relative">
                <img 
                  ...
                  className="h-12 w-12 rounded-full object-cover ring-2 ring-white/30 group-hover:ring-white/60 transition-all duration-300"
                />
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <div className="flex items-center space-x-4">
              <Link
                to="/joinus"
                className="bg-white text-blue-600 px-6 py-2.5 rounded-full text-sm font-semibold hover:bg-white/90 hover:shadow-lg transform hover:scale-105 transition-all duration-300 shadow-md"
              >
                Get Started
              </Link>
            </div>
        ...
        <div className="px-4 pt-2 pb-6 space-y-2 bg-blue-600/95 backdrop-blur-md border-t border-white/20">
          ...
          <div className="pt-4">
            <Link
              to="/joinus"
              onClick={closeMenu}
              className="block w-full text-center bg-white text-blue-600 px-6 py-3 rounded-full text-base font-semibold hover:bg-white/90 hover:shadow-lg transition-all duration-300 shadow-md"
            >
              Get Started
            </Link>
          </div>
